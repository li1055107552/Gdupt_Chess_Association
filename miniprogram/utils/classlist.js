...
function instituteColumnChange(nowIndex,column,value){   //nowIndex:当前选择的校区 column:修改的列数 value:修改的值
  ...
  if(column == 0){    //更改校区时
    if(value == 0){   //改为官渡校区
      data.IArray[1] = ['机电工程学院', '自动化学院', '电子信息工程学院', '计算机学院', '建筑工程学院', '理学院', '文法学院', '体育学院', '艺术与设计学院'];
      data.CArray[0] = ['机械设计制造及自动化', '过程装备与控制工程', '材料成型及控制工程', '工业设计', '工业工程', '能源与动力工程', '焊接技术与工程', '安全工程'];
      data.IIndex = [0,0]
    }
    else if(value == 1){  //改为西城校区
      data.IArray[1] = ['石油工程学院', '化学工程学院', '化学学院', '材料科学与工程学院', '环境科学与工程学院', '生物与食品工程学院', '经济管理学院', '外国语学院'];
    ...
    if(nowIndex == 0){  //当前为官渡校区 更改学院
      switch(value){
        ...
        case 1:   //自动化学院
          ...
          break;
        case 2:   //电子信息工程学院
          data.CArray[0] = ['电子信息工程', '电子信息科学与技术'];
          break;
        case 3:   //计算机学院
          data.CArray[0] = ['计算机科学与技术', '网络工程', '物联网工程'];
          break;
        case 4:   //建筑工程学院
          data.CArray[0] = ['建筑学', '土木工程'];
          break;
        case 5:   //理学院
          data.CArray[0] = ['教育技术学', '数学与应用数学', '信息与计算科学', '物理学', '地理科学', '新能源科学与工程'];
          break;
        case 6:   //文法学院
          data.CArray[0] = ['法学', '汉语言文学', '历史学', '学前教育（师范）'];
          break;
        case 7:   //体育学院
          data.CArray[0] = ['社会体育指导与管理'];
          break;
        case 8:   //艺术与设计学院
      ...
      switch(value){
        case 0:   //石油工程学院
          ...
          break;
        case 1:   //化学工程学院
          data.CArray[0] = ['化学工程与工艺（卓越班）', '化学工程与工艺', '能源化学工程'];
          break;
        case 2:   //化学学院
          data.CArray[0] = ['应用化学'];
          break;
        case 3:   //材料科学与工程学院
          data.CArray[0] = ['高分子材料与工程'];
          break;
        case 4:   //环境科学与工程学院
